...
ui <- fluidPage(
  ...
  # Application title
  titlePanel("Wöhler Curve Estimation"),
  ...
  tabsetPanel(#type = "tabs",
    ...
    tabPanel("Result", 
             ...
             sidebarPanel(
               ...
               # sliderInput("xlim", "X-Range", value = c(3, 8), min = 1, max = 10),
               # sliderInput("ylim", "Y-Range", value = c(3, 8), min = 1, max = 1000),
